...
def tst_stuff():
    person = Person()
    event1 = Event(parent=person, loggedDateTime=util.Date(2000, 1, 10), dateTime=util.Date(1900, 1, 1), description='item1')
    event2 = Event(parent=person, loggedDateTime=util.Date(2000, 2, 10), dateTime=util.Date(1900, 1, 1), description='item2')
    event3 = Event(parent=person, loggedDateTime=util.Date(2000, 3, 10), dateTime=util.Date(1900, 1, 1), description='item3')
...
def test_clear(tst):
    ...
    assert tst.itemProp('loggedStartDateTimeButtons.dateTextInput', 'text') == '01/01/2001'
    assert tst.itemProp('loggedEndDateTimeButtons.dateTextInput', 'text') == '02/02/2002'
    ...
    assert tst.itemProp('loggedStartDateTimeButtons.dateTextInput', 'text') == '--/--/----'
    assert tst.itemProp('loggedEndDateTimeButtons.dateTextInput', 'text') == '--/--/----'
