...
def test_add_new_person(dlg):
    ...
    dlg.keyClicks('startDateButtons.dateTextInput', BORN_DATE,
                 resetFocus=RESET_FOCUS, returnToFinish=RETURN_TO_FINISH)
    dlg.keyClicksClear('startDateButtons.timeTextInput')
    dlg.keyClicks('startDateButtons.timeTextInput', BORN_TIME,
                 resetFocus=RESET_FOCUS, returnToFinish=RETURN_TO_FINISH)
