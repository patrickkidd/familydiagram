...
// Variant 3B: Discussion picker in header dropdown
// Tap discussion title to switch within current diagram
...
Window {
    ...
    Rectangle {
        ...
        // Discussion title (tappable) - only on Discuss tab
        Rectangle {
            anchors.centerIn: parent
    ...
    // Drawer (diagrams only, no discussions)
    Drawer {
        id: drawer
