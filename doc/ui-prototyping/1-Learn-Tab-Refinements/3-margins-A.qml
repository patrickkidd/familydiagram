...
Rectangle {
    ...
    // MARGINS: Tight (12px horizontal, 8px card spacing)
    property int hMargin: 12
    ...
    Rectangle {
        ...
        Text { id: labelText; anchors.centerIn: parent; text: "A: Tight (12px margins, 8px gaps)"; font.pixelSize: 11; color: textSecondary }
    }
}
