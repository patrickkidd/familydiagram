...
Rectangle {
            ...
            Rectangle {
                ...
                Rectangle {
                    ...
                    Rectangle {
                        ...
                        color: "#00000030"
                        Text { anchors.centerIn: parent; text: "\u2715"; font.pixelSize: 14; color: "#ffffffee" }
                    }
                }
        ...
        ListView {
            ...
            delegate: Rectangle {
                ...
                Row {
                    ...
                    Rectangle { width: 4; height: 48; radius: 2; color: index % 2 == 0 ? anxietyColor : symptomColor }

                    Column {
                        spacing: 5
                        Row {
                            spacing: 12
                            Text { text: "May 16, 2025"; font.pixelSize: 14; font.bold: true; color: anxietyColor }
                            Text { text: "User"; font.pixelSize: 14; color: textSecondary }
                        }
                        Text { text: "Stressed with race committee"; font.pixelSize: 16; color: textPrimary }
                    }
                }
    ...
    Rectangle {
        ...
        Text { id: labelText; anchors.centerIn: parent; text: "C: Generous (16px hero margin, 32px title)"; font.pixelSize: 11; color: textSecondary }
    }
}
