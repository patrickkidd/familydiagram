...
Rectangle {
    ...
    // MARGINS: Medium (16px horizontal, 12px card spacing)
    ...
    Rectangle {
        ...
        Text { id: labelText; anchors.centerIn: parent; text: "B: Medium (16px margins, 12px gaps)"; font.pixelSize: 11; color: textSecondary }
    }
}
