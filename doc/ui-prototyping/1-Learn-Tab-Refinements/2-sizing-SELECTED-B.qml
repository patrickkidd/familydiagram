...
Rectangle {
    ...
    Column {
        ...
        Rectangle {
            ...
            Row {
                ...
                Row {
                    spacing: 4
                    Rectangle { width: 12; height: 12; radius: 2; color: symptomColor }
                    Text { text: "Symptom"; font.pixelSize: 12; font.bold: true; color: symptomColor }
                }
                Row {
                    spacing: 4
                    Rectangle { width: 12; height: 12; radius: 2; color: anxietyColor }
                    Text { text: "Anxiety"; font.pixelSize: 12; font.bold: true; color: anxietyColor }
                }
                Row {
                    spacing: 4
                    Rectangle { width: 12; height: 12; radius: 2; color: relationshipColor }
                    Text { text: "Relationship"; font.pixelSize: 12; font.bold: true; color: relationshipColor }
                }
                Row {
                    spacing: 4
                    Rectangle { width: 12; height: 12; radius: 2; color: functioningColor }
    ...
    Rectangle {
        ...
        Text {
            id: labelText
            anchors.centerIn: parent
            text: "B: Medium (12-13px fonts, 32px buttons)"
            font.pixelSize: 11
            color: textSecondary
        }
    }
