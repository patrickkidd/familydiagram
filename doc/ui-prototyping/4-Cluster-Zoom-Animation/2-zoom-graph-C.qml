// Variant C: Zoom into SARF Graph - Events Integrated with Graph
// Events shown as vertical bands on the SARF graph itself
// Cleaner integration of time, events, and SARF variables
import QtQuick 2.15
...
Rectangle {
    ...
    Row {
        ...
        Row {
            spacing: 3
            Rectangle { width: 1; height: 10; color: "#ffffff40"; anchors.verticalCenter: parent.verticalCenter }
            Text { text: "Event"; font.pixelSize: 8; color: "#606070" }
        }
    }
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                Rectangle {
                    ...
                    Text { anchors.centerIn: parent; text: "<"; font.pixelSize: 9; font.bold: true; color: "white" }
            ...
            // Full-height SARF graph with event bands
            Item {
                id: sarfGraph
                anchors.fill: parent
                ...
                function yForValue(val) { return height * (1 - val * 0.9) - 4 }

                // Event vertical bands (behind SARF lines)
                Repeater {
                    model: sarfGraph.cluster ? sarfGraph.cluster.events : []

                    Rectangle {
                        x: sarfGraph.xForYear(modelData.year) - 0.5
                        y: 0
                        width: 1
                ...
                // Y-axis scale hints
                Text { x: 2; y: 2; text: "High"; font.pixelSize: 6; color: "#404050" }
                Text { x: 2; y: sarfGraph.height - 14; text: "Low"; font.pixelSize: 6; color: "#404050" }
            }
            ...
            Row {
                ...
                Text {
                    text: focusedClusterIndex >= 0 ? formatDateRange() : ""
                    font.pixelSize: 7
                    color: "#505060"

                    function formatDateRange() {
                        var c = clusters[focusedClusterIndex]
                        var startMonth = Math.floor((c.startYear - 2025) * 12)
                        var endMonth = Math.floor((c.endYear - 2025) * 12)
                        var months = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"]
                        return months[startMonth % 12] + " → " + months[endMonth % 12]
                    }
                }
                ...
                Text {
                    text: focusedClusterIndex >= 0 ? formatDuration() : ""
                    font.pixelSize: 7
                    color: "#505060"

                    function formatDuration() {
                        var c = clusters[focusedClusterIndex]
                        var days = Math.round((c.endYear - c.startYear) * 365)
                        return days + " days"
                    }
                }
            }
