...
// Iteration 16: Compact layout, formatted dates, fixed who position
// - Pills only for Shift events with relationship set
// - Foreground circle for: Bonded, Birth, Married, Adopted, Moved, Separated, Divorced
// - Overlapped SARF symbols for Shift events
// - Grey box for Death
    ...
    ListView {
        ...
        delegate: Rectangle {
            ...
            Item {
                ...
                // Life events (birth, married, etc): foreground filled circle
                Rectangle {
                ...
                // Shift events: stacked SARF symbols (cascading diagonal like a hand of cards)
                Item {
                    visible: delegateRoot.isShift
                    anchors.centerIn: parent
                    width: 40; height: 40

                    // Calculate offsets for staggered diagonal arrangement
                    ...
                    // Stagger: each symbol offset 4px right and 6px down from previous
                    SymptomSymbol {
