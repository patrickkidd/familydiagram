...
// Iteration 6: Fixed scroll to keep selected event in view
...
Window {
    ...
    // Mini graph properties
    property real miniGraphY: 95
    property real miniGraphH: 80
    ...
    function scrollToEvent(idx) {
        ...
        // since we're selecting idx, any previously selected item collapses
        var targetY = idx * 100
    ...
    ListView {
        ...
        x: 0; y: 200
        width: parent.width
        height: parent.height - 250  // Account for legend at bottom
        clip: true
        spacing: 0
        model: events
