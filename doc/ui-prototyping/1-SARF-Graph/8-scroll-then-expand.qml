...
// Iteration 8: Scroll first, then expand after animation completes
...
Window {
    ...
    property int pendingSelection: -1  // Used to delay expansion until scroll completes
    ...
    // Scroll to event, then expand after scroll completes
    ...
    ListView {
        ...
        NumberAnimation {
            ...
            onFinished: {
                // Expand the item after scroll completes
