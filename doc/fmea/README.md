...
Failure Mode and Effects Analysis records for Family Diagram.

Each file is a timestamped FMEA from a specific analysis session. Files are named `YYYY-MM-DD--slug.md` for chronological sorting.
