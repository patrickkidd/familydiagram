...
from pkdiagram.scene import PathItem, Property, Callout, Person
from pkdiagram.views import (
    DragPanner,
    PanZoomer,
    WheelZoomer,
    HelpOverlay,
...
from pkdiagram.widgets import Legend, PixmapPushButton
...
class View(QGraphicsView):
    ...
    def __init__(self, parent, ui):
        ...
        self.dragPanner = DragPanner(self)
        self.wheelZoomer = WheelZoomer(self)
        self.panZoomer = PanZoomer(self)
        ...
        #
        self.showToolBarButton = PixmapPushButton(
    ...
    def numAnimatingItems(self):
        ...
        nAnimating = 0
        for item in self.scene().items():
            if isinstance(item, Person) and item.animatingPos:
                nAnimating += 1
            elif (
