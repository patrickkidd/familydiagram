"""
TODO: This is currently in pkdiagram.app but really should be scoped to the
qmlEngine. maybe even moved to qmlengine.py.
"""
...
class QmlUtil(QObject, QObjectHelper):
    ...
    def initColors(self):
        darkLightMode = QApplication.instance().prefs.value(
