from .pyqt import QQuickWidget, Qt, QObject, QWidget, QUrl, QFileInfo, QVBoxLayout, QFontDatabase, QTimer, pyqtSignal, pyqtProperty
...
class FileManager(QWidget, QmlWidgetHelper):
    ...
    def __init__(self, session, parent=None):
        ...
        self.qml.rootObject().localFilesShownChanged.connect(self.onLocalFilesShownChanged)
        self.clearSelection()
