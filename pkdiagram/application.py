...
from .pyqt import Qt, QApplication, QIcon, QPixmap, QFileInfo, qInstallMessageHandler, QStandardPaths, QDateTime, QFontDatabase, QEvent
...
class Application(QApplication):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if pepper.BUGSNAG_API_KEY:
            ...
            root_folder_path = os.path.realpath(os.path.join(os.path.dirname(os.path.realpath(__file__)), '..'))
            ...
            def bugsnag_before_notify(event):
                ...
                event.add_tab("account", {
                    'licenses': [license_info['policy']['name'] for license_info in user.licenses if license_info['active']]
                })
                event.add_tab("device", {
                    "os.uname": os.uname()
                })
        ...
        def qtMessageHandler(msgType, context, msg):
            ...
            logging.getLogger().info(msg, extra={
        ...
        self.appFilter = util.AppFilter(self) # Move global app filtering to C++ for speed
        ...
        if util.IS_DEV and util.prefs().value('iCloudWasOn', defaultValue=False, type=bool):
        ...
        ret1 = QFontDatabase.addApplicationFont(util.QRC + 'fonts/SF-Pro-Text-Regular.otf')
        ret2 = QFontDatabase.addApplicationFont(util.QRC + 'fonts/SF-Pro-Text-Bold.otf')
        ret3 = QFontDatabase.addApplicationFont(util.QRC + 'fonts/SF-Pro-Display-Bold.otf')
        ret4 = QFontDatabase.addApplicationFont(util.QRC + 'fonts/Helvetica65Medium_22443.ttf')
        ret5 = QFontDatabase.addApplicationFont(util.QRC + 'fonts/HelveticaNeueBold.otf')        
