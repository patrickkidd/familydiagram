...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionView_Diagram = QtGui.QAction(MainWindow)
        ...
        self.actionEditor_Mode = QtGui.QAction(MainWindow)
        self.actionEditor_Mode.setCheckable(True)
        self.actionEditor_Mode.setObjectName("actionEditor_Mode")
        self.actionDocuments_Folder = QtGui.QAction(MainWindow)
        self.actionDocuments_Folder.setObjectName("actionDocuments_Folder")
        self.actionAutosave_Folder = QtGui.QAction(MainWindow)
        self.actionAutosave_Folder.setObjectName("actionAutosave_Folder")
        ...
        self.actionShow_Timeline = QtGui.QAction(MainWindow)
        ...
        self.actionClear_All_Events = QtGui.QAction(MainWindow)
        self.actionClear_All_Events.setObjectName("actionClear_All_Events")
        self.actionUndo_History = QtGui.QAction(MainWindow)
        self.actionUndo_History.setObjectName("actionUndo_History")
        self.actionHide_Emotional_Process = QtGui.QAction(MainWindow)
        ...
        self.actionFusion = QtGui.QAction(MainWindow)
        self.actionFusion.setCheckable(True)
        self.actionFusion.setObjectName("actionFusion")
        self.actionPrimary_Cutoff = QtGui.QAction(MainWindow)
        ...
        self.actionStart_Macro = QtGui.QAction(MainWindow)
        self.actionStart_Macro.setObjectName("actionStart_Macro")
        self.actionStop_Macro = QtGui.QAction(MainWindow)
        self.actionStop_Macro.setObjectName("actionStop_Macro")
        self.actionPlay_Macro = QtGui.QAction(MainWindow)
        self.actionPlay_Macro.setObjectName("actionPlay_Macro")
        self.actionShow_Diagram = QtGui.QAction(MainWindow)
        self.actionShow_Diagram.setObjectName("actionShow_Diagram")
        self.actionJump_to_Now = QtGui.QAction(MainWindow)
        self.actionJump_to_Now.setObjectName("actionJump_to_Now")
        self.actionNext_Event = QtGui.QAction(MainWindow)
        self.actionNext_Event.setObjectName("actionNext_Event")
        self.actionPrevious_Event = QtGui.QAction(MainWindow)
        ...
        self.actionAdd_Relationship = QtGui.QAction(MainWindow)
        self.actionAdd_Relationship.setObjectName("actionAdd_Relationship")
        self.actionShow_Relationships = QtGui.QAction(MainWindow)
        self.actionShow_Relationships.setObjectName("actionShow_Relationships")
        self.actionShow_Cursor_Position = QtGui.QAction(MainWindow)
        ...
        self.actionShow_Current_Date = QtGui.QAction(MainWindow)
        ...
        self.actionProfessional_License = QtGui.QAction(MainWindow)
        ...
        self.actionShow_Account = QtGui.QAction(MainWindow)
        self.actionShow_Account.setMenuRole(QtGui.QAction.ApplicationSpecificRole)
        self.actionShow_Account.setObjectName("actionShow_Account")
        self.actionShow_Welcome = QtGui.QAction(MainWindow)
        self.actionShow_Welcome.setMenuRole(QtGui.QAction.ApplicationSpecificRole)
        self.actionShow_Welcome.setObjectName("actionShow_Welcome")
        self.actionNo_License = QtGui.QAction(MainWindow)
        self.actionNo_License.setCheckable(True)
        self.actionNo_License.setObjectName("actionNo_License")
        self.actionClear_Recent_Menu = QtGui.QAction(MainWindow)
        self.actionClear_Recent_Menu.setObjectName("actionClear_Recent_Menu")
        self.actionClear_Preferences = QtGui.QAction(MainWindow)
        self.actionClear_Preferences.setObjectName("actionClear_Preferences")
        self.actionBeta_License = QtGui.QAction(MainWindow)
        ...
        self.actionShow_Graphical_Timeline = QtGui.QAction(MainWindow)
        ...
        self.actionDeselect_All_Reverse_Tags = QtGui.QAction(MainWindow)
        ...
        self.actionShow_View_Scene_Rect = QtGui.QAction(MainWindow)
        ...
        self.actionInspect_Notes = QtGui.QAction(MainWindow)
        self.actionInspect_Notes.setObjectName("actionInspect_Notes")
        self.actionInspect_Timeline = QtGui.QAction(MainWindow)
        self.actionInspect_Timeline.setObjectName("actionInspect_Timeline")
        self.actionInspect_Meta = QtGui.QAction(MainWindow)
        self.actionInspect_Meta.setObjectName("actionInspect_Meta")
        self.actionInspect_Item = QtGui.QAction(MainWindow)
        self.actionInspect_Item.setObjectName("actionInspect_Item")
        self.actionExpand_Graphical_Timeline = QtGui.QAction(MainWindow)
        ...
        self.actionHide_Variable_Steady_States = QtGui.QAction(MainWindow)
        ...
        self.actionShow_Items_with_Notes = QtGui.QAction(MainWindow)
        ...
        self.menuFile.addAction(self.actionAutosave_Folder)
        ...
        self.menuEdit.addAction(self.actionArrange_Selection)
        ...
        self.menuView.addAction(self.actionHide_SARF_Graphics)
        self.menuView.addSeparator()
        ...
        self.menuDebug.addAction(self.actionExport_DiagramData_JSON)
        ...
        self.menuDebug.addSeparator()
        self.menuDebug.addAction(self.actionTest_URL_Authentication)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionAutosave_Folder.setText(_translate("MainWindow", "Open Autosave Folder"))
        ...
        self.actionTest_URL_Authentication.setText(_translate("MainWindow", "Authenticate Training App"))
        ...
        self.actionShow_Graphical_Timeline.setShortcut(_translate("MainWindow", "Ctrl+6"))
        ...
        self.actionShow_Settings.setShortcut(_translate("MainWindow", "Ctrl+5"))
        ...
        self.actionExpand_Graphical_Timeline.setShortcut(_translate("MainWindow", "Ctrl+7"))
        ...
        self.actionExport_DiagramData_JSON.setText(_translate("MainWindow", "Export DiagramData JSON"))
