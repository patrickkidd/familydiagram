...
class PushButton(PixmapPushButton, ButtonItemMixin):
    def __init__(
        self,
        objectName: str,
        pixmap: str = None,
...
class ToolButton(PixmapToolButton, ButtonItemMixin):
    def __init__(
        self,
        objectName: str,
        pixmap: str = None,
...
class ItemToolBar(ToolBar):
    ...
    def __init__(self, parent, ui):
        ...
        self.pencilColorBox = ColorBox(self.pencilPopup)
